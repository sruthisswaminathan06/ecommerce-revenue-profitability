...
Sample Data: Includes realistic entries for products, customers, orders, and payments.
Powerful Queries:
...
Customers: Customer info (name, region, signup date)
Orders: Links customers to products with quantity and date
Payments: Payment method and status for each order

<img width="1536" height="1024" alt="image" src="https://github.com/user-attachments/assets/a9b406be-26a5-4ffa-bb47-72a78b8c4eba" />

⚡ How to Run

Install MySQL or any SQL-compatible environment.
